...
func init() {
	...
	flag.StringVar(&httpAddr, "haddr", internal.DefaultHTTPAddr, "Set the HTTP bind address")
	flag.StringVar(&raftAddr, "raddr", internal.DefaultRaftAddr, "Set Raft bind address")
